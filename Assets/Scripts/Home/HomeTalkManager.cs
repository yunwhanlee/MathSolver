...
public class HomeTalkManager : TalkManager {
    ...
    public override void generateData() {
        ...
        talkDt.Add((int)ID.OPEN_MAP3_UNLOCK_BG1_ACCEPT, new string[] { //* #1
            ...
            , "그게 아니..:2"
            , "몽키킬러가 확실하다! 체포하라!!:17"
            , "안돼! 멈춰!! :14_FLIP:11_FLIP"
            , "너희들은 마음씨 착한\n개구리와개미?!:17"
            , "이 분은! 몽키킬러가 아니개굴! :11_FLIP"
            , "저희 정글을 도와주시는 수학해결사다개미! :14_FLIP"
        ...
        talkDt.Add((int)ID.OPEN_MAP3_UNLOCK_BG1_REWARD, new string[] {
            "고맙다! 수학선생!!:18"
            , "하하! 별말씀을요!:1"
            , "신전의 수학고민을 해결해준 덕분에:18"
            , "몽키신님의 노여움이 사그라들어 날씨가 좋아졌다!:18"
            , "처음엔 정말 미안했다. 아기원숭이를 때린다는 줄 알고.:19"
            , "아 맞다! 그 아기원숭이는 어딧나요?:1"
            , "흠.. 그러고보니 나도 그 이후 본적이 없다..:18"
            , "스으윽..(정글 신전 높은 곳에서) :-1"
            , "허.허.허.허\n나를 찾고 있는가.끼?..:8"
            , "아앗?! 너는!!:1"
            , "(퍼엉!):-1"
            ...
            , "다 당신은?! 몽키신님??!!:19_FLIP"
            , "!!!:2"
            , "황금바나나 몽키신님을 위하여.. 우끼!:18_FLIP:11_FLIP:14_FLIP"
            , "허.허.. 미안하게 됫끼.\n정글에 수학고민이 쌓여가,:20"
            , "스트레스로 인해 날씨가 안좋아졌끼..:20"
            , "하지만, 우리원숭이들은 정글밖에 나가본적이 없끼..:20"
            , "그래서 이 내가 직접 수학해결사를 찾아나섯다.끼.:20"
            , "아아.. 그런거였구나..(감동):0"
            , "과격하게 또때튀를 한건 미안하끼.. 나에겐 시간이 별로 없었다끼..:20"
            , "아닙니다.. 정글을 위해서 하신건데요.:1"
            , "크허어엉 몽키신님..:19_FLIP"
            , "(주륵..):14_FLIP"
            , "이제.. 시간이 다 됫구만..끼:20"
            , "나는 다시 하늘로 올라가겠다끼..:20"
            , "수학영웅이여, 부디 이 선물을 받아주게끼!:20"
            , "우리 정글의 수호자이며 친구라는 증표다끼!:20"
            , "그럼...:20"
            , "(스르르륵..):-1"
            , "(정글과 이 세계의 평화를 부탁한디끼..끼...끼....):-1"
            , "몽키신님을 위하여.. 우끼!:18_FLIP"
            , "우끼!!!:1:11_FLIP:14_FLIP"
            , "정글 메인퀘스트 끝.:-1"
        });
