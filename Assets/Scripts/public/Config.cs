...
public static class Config {
    ...
    public readonly static int[] MINIGAME1_UNLOCK_SCORES = new int[3] {50, 120, MINIGAME1_MAX_VAL};
    ...
    public readonly static int[] MINIGAME2_UNLOCK_SCORES = new int[3] {50, 120, MINIGAME1_MAX_VAL};
    ...
    public readonly static int[] MINIGAME3_UNLOCK_SCORES = new int[3] {50, 120, MINIGAME3_MAX_VAL};
